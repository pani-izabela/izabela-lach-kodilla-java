...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://pani-izabela.github.io/";
    ...
    private String createCrudAppTestTask() throws InterruptedException {
        ...
        WebElement addButton = driver.findElement(By.xpath(XPATH_ADD_BUTON));
        addButton.click();
        Thread.sleep(2000);
    ...
    private void sendTestTaskToTrello(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//from[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(theForm-> {
                    ...
                    WebElement selectElementList = theForm.findElement(By.xpath(".//select[2]"));
                    Select selectList = new Select(selectElementList);
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("pani_izabela");
        driverTrello.findElement(By.id("password")).sendKeys("nektor11");
