...
public final class Board extends Prototype{//dzięki dopisaniu extends Prototype nasza klasa została również oznaczona jako obsługująca klonowanie (klasa Prototype implementuje interfejs Cloneable).
    String name;
